...
$synth.Rate = -1
$synth.Volume = 100
$synth.SetOutputToWaveFile('C:\\Users\\lithi\\GitHub\\smart-resource-allocation\\docs\\product-demo\\product-narration.wav')
$synth.Speak('Hi, this is AidFlow, an AI powered crisis coordination platform for NGOs.
